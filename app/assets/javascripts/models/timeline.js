(function (M, $) {
  function Timeline(model) {
    ...
    var me = this;
    M.models.SpaceTime.cache.getWhenReady(this.space_time_id, function (x) {
      me.spaceTime = x;
    });
    M.models.Thing.cache.getWhenReady(this.thing_id, function (x) {
      me.thing = x;
    });

    Timeline.cache.put(this);
  }
